...
<div class="p-4 sm:ml-64 mt-16">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-4">
        <div class=" justify-between">
            <div
                class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-start pb-4 gap-4">
                <div>
                    ...
                    <div class="relative max-w-sm ">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true"
                                ...
                                <path d=" M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2
                0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1
                0-2Z" />
                            </svg>
                        </div>
            ...
            <div
                ...
                <div id="exportDropdown"
                    ...
                    style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(622.4px, 69.6px, 0px);"
                        ...
                        <li><button id="export-json"
                                class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"><svg
                                    ...
                                    <path fill-rule="evenodd"
                                        ...
                                        clip-rule="evenodd"></path>
                                </svg><span>Export JSON</span></button></li>
                        <li><button id="export-txt"
                                class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"><svg
                                    ...
                                    <path fill-rule="evenodd"
                                        ...
                                        clip-rule="evenodd"></path>
                                </svg><span>Export TXT</span></button></li>
                        <li><button id="export-sql"
                                class="group inline-flex w-full items-center rounded-md px-3 py-2 text-sm text-gray-500 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white"><svg
                                    class="me-1.5 h-4 w-4 text-gray-400 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                </svg><span>Export SQL</span></button></li>
                    </ul>
                </div>
            </div>
        </div>
